...
def convert_seconds(input):
    hour=int(math.floor(input/3600))
    input-=hour*3600
    minute=int(math.floor(input/60))
...
def download_time(size,unit1,speed,unit2):
        size=change_unit(size,unit1)
        speed=change_unit(speed,unit2)
        return convert(1.0*size/speed)
